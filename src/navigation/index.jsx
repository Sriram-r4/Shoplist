...
export default function AppNavigation() {
    ...
    return (
      <Stack.Navigator
        screenOptions={{
         ...
         initialRouteName={users.length!=0?'HomeTab':"Welcome"}
      >
  ...
  function DrawerWindow() {
    return (
      <Drawer.Navigator initialRouteName='Deleted' screenOptions={{ drawerStyle: { backgroundColor: "#E0F2F1" }, headerStyle: { backgroundColor: "#14b8a6", }, headerTitleStyle: { color: "#fff" }, headerTintColor: "#FFFFFF" }} >
        <Drawer.Screen options={{
          drawerActiveBackgroundColor: '#B2DFDB', drawerActiveTintColor: '#00796B', drawerIcon: ({ color, size }) => (
            <MaterialIcons name="info-outline" size={20} color={"#00695c"} />
          ), drawerInactiveTintColor: "#76a89f", drawerLabelStyle: { color: "#00695C" }
        }} name="About" component={AboutScreen} />
        <Drawer.Screen options={{
          drawerActiveBackgroundColor: '#B2DFDB', drawerActiveTintColor: '#00796B', drawerIcon: ({ color, size }) => (
            <MaterialIcons name="delete" size={20} color={"#00695c"} />
          ), drawerInactiveTintColor: "#76a89f", drawerLabelStyle: { color: "#00695C" }
        }} name="Deleted" component={DeletedTabs} />
      </Drawer.Navigator>
    )
  }
