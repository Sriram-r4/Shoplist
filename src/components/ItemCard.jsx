...
export default function ItemCard({ items, showCardMessage,deleteDocument,updateDocument}) {

  let num=0;

  const handleUpdate=(item)=>{
    const updatedData = { quantity: 10,amount:1000 };
        const itemToUpdate = { item_id: item.item_id, itemName: item.itemName };
        updateDocument(itemToUpdate, updatedData);
  }
