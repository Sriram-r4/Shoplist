                ...
                <Stepper.Step label="Item"
                    ...
                    <View style={{ width: wp(100), height: hp(61.7) }} className='flex items-center p-1 justify-center'>
                        <View style={{ width: wp(95), height: hp(59) }} className='px-3  py-2 m-1'>
                            ...
                            <MultiInputTable itemData={itemData} navigation={navigation} itemname={selectedItem !== undefined ? selectedItem : {}} handleItemData={handleItemData} />
                            <ItemCard items={items} showCardMessage={showCardMessage} />
