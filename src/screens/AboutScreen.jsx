    ...
    return (
        <SafeAreaView style={{
            ...
            <View style={{ width: wp(100) }}>
                ...
                <Text  className='text-teal-800 font-normal text-base mx-3 px-2'>&#10133; Create multiple New Lists</Text>
                <Text  className='text-teal-800 font-normal text-base mx-3 px-2'>&#10060; Delete Lists</Text>
                ...
                <Text  className='text-teal-800 font-normal text-base mx-3 px-2'>&#128279; Combine lists to create groups</Text>
                <Text  className='text-teal-800 font-normal text-base mx-3 px-2'>&#128278; Save lists </Text>
